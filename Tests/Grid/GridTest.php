...
class GridTest extends TestCase
{
    ...
    public function testSetFirstPageIfNoRowsFromSourceIfDataAlreadyDataAndRequestedPageNotFirst()
    {
        ...
        $source
            ...
            ->method('executeFromData')
            ->withConsecutive(
                [$columns->getIterator(), $page, $this->anything(), $this->anything()],
                [$columns->getIterator(), 0, $this->anything(), $this->anything()]
            )
            ->willReturn(new Rows());
    ...
    public function testSetFirstPageIfNoRowsFromSourceIfDataNotLoadedAndRequestedPageNotFirst()
    {
        ...
        $source
            ...
            ->method('execute')
            ->withConsecutive(
                [$columns->getIterator(), $page, $this->anything(), $this->anything(), $this->anything()],
                [$columns->getIterator(), 0, $this->anything(), $this->anything(), $this->anything()]
            )
            ->willReturn(new Rows());
    ...
    public function testColumnsNotOrderedDuringRedirectIfNoOrderRequested()
    {
        $this->arrangeGridSourceDataLoadedWithEmptyRows();
    ...
    public function testSetDefaultSessionFiltersIfNotSessionDataDuringRedirect()
    {
        $this->arrangeGridSourceDataLoadedWithEmptyRows();
    ...
    public function testSetDefaultPageIfNotSessionDataDuringRedirect()
    {
        $row = $this->createMock(Row::class);
        $rows = new Rows();
        $rows->addRow($row);
    ...
    public function testSetDefaultPageIfSessionDataXmlHttpRequestAndNotExportDuringRedirect()
    {
        $row = $this->createMock(Row::class);
        $rows = new Rows();
        $rows->addRow($row);
    ...
    public function testSetDefaultOrderAscIfNotSessionDataDuringRedirect()
    {
        $this->arrangeGridSourceDataLoadedWithEmptyRows();
    ...
    public function testSetDefaultOrderDescIfNotSessionDataDuringRedirect()
    {
        $this->arrangeGridSourceDataLoadedWithEmptyRows();
    ...
    public function testSetDefaultOrderIfSessionDataXmlHttpRequestAndNotExportDuringRedirect()
    {
        $this->arrangeGridSourceDataLoadedWithEmptyRows();
    ...
    public function testSetDefaultLimitIfSessionDataXmlHttpRequestAndNotExportDuringHandleRedirect()
    {
        $this->arrangeGridSourceDataLoadedWithEmptyRows();
        $this->arrangeGridPrimaryColumn();
    ...
    public function testProcessDefaultTweaksIfNotSessionDataDuringRedirect()
    {
        $this->arrangeGridSourceDataLoadedWithEmptyRows();
        $this->arrangeGridPrimaryColumn();
    ...
    public function testProcessDefaultTweaksIfSessionDataXmlHttpRequestAndNotExportDuringRedirect()
    {
        $this->arrangeGridSourceDataLoadedWithEmptyRows();
        $this->arrangeGridPrimaryColumn();
    ...
    public function testItReturnsSameRedirectIfAlreadySetted()
    {
        // @todo
    }
    ...
    private function arrange($gridConfigInterface = null, $id = 'id', $httpKernel = null)
    {
        ...
        )->willReturnOnConsecutiveCalls($this->router, $requestStack, $authChecker, $httpKernel);
